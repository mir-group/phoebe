...
int FullBandStructure::getPointIndex(const Eigen::Vector3d &crystalCoords,
...
std::vector<int> FullBandStructure::getReduciblesFromIrreducible(const int &ik) {
