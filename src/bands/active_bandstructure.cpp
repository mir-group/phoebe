...
//numVelStates = 0; 	long numEigStates = 0; 	for ( long ik=0; ik<numPoints; ik++ )
...
//			Eigen::MatrixXcd
//theseEigvecs(numFullBands,numBands(ik)); 			long ibAct = 0; 			for ( long
//ibFull=filteredBands[ik][0]; 					ibFull<=filteredBands[ik][1]; ibFull++) {
//				theseEigvecs.col(ibAct) =
//theseEigenvectors.col(ibFull); 				ibAct++;
//			}
...
//{ 				for ( long i=0; i<3; i++ ) { 					thisVels(ib1New,ib2New,i) =
