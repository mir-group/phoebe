...
class PeriodicTable {
public:
  struct Element elements[109] = {{"H", 1, 1.008, 0.0002789062238058872},
...
/*
 ...
 def get_coupling(X):
     ...
     coupling = sum([ _[1]*(1.-_[0]/average_mass)**2 for _ in
 zip(masses,abundances) ]) print('{{"{}", {}, {}, {}}},'.format(X.symbol,
 X.atomic_number, X.mass, float(coupling)))
