...
if __name__ == "__main__":
    ...
    parser.add_argument("xaxis", help="x-axis value to plot against, either n or T")
    ...
    # load in either phonon or electron data
    dataKeys = data.keys()
    ...
    xaxis = args.xaxis
    if xaxis not in allowedXaxis:
        raise ValueError("xaxis value choice must be either n or T")
    def mapCoord(x):
        if x == "x": return 0
        elif x == "y": return 1
        elif x == "z": return 2
